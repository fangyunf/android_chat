...
public class MainActivity extends BaseActivity implements EasyPermissions.PermissionCallbacks {
    ...
    private ShopNewFragment mShopFragment;
...
//        AppSkinConfig.getInstance().getAppSkinStyle() == AppSkinConfig.AppSkin.commonSkin;
        ...
        // 商城 / 消息(单聊+群聊 type=3) / 联系人 / 我的
        mShopFragment = new ShopNewFragment();
    ...
    public void tabClick(View view) {
        ...
        if (view == activityMainBinding.conversationBtnGroup) {
            AppProxy.getInstance().showType = 3;
    ...
    private void resetTabSkin() {
        // 0 商城 / 1 消息 / 2 联系人 / 3 我的
        if (mCurrentTab == activityMainBinding.conversationBtnShop) {
            ...
            changeStatusBarColor(R.color.fun_page_bg_color);
        } else if (mCurrentTab == activityMainBinding.contactBtnGroup) {
