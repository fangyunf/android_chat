...
import com.turunsi.yaoxin.databinding.ActivityEditNicknameBinding;
...
public class EditUserInfoActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding.tvDone.setOnClickListener(v -> {
            ...
            CommonRepo.updateUserInfo(map, new FetchCallback<Void>() {
                @Override
                ...
                public void onFailed(int code) {
                    if (code == Constant.NETWORK_ERROR_CODE) {
                        ...
                        Toast.makeText(getApplicationContext(), getString(R.string.request_fail) + code, Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    private void setCommonSkin() {
        ...
        ViewGroup.MarginLayoutParams layoutParamsS = (ViewGroup.MarginLayoutParams) binding.etNickname.getLayoutParams();
