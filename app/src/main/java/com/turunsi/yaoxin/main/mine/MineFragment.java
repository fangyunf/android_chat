...
//                        binding.mineFragmentPacketMoneyDetailTv.setText("￥ " + NumberUtil.formartMoney(bean.balance));
    ...
    private void _initItems() {
        ...
        binding.fragmentMineDeviceView.setOnClickListener(this);
...
//                    .navigate();
//        }
        else if (v == binding.fragmentMineDeviceView) {
            DeviceManageActivity.start(DeviceManageActivity.class, getContext(), null);
