...
import com.turunsi.yaoxin.databinding.ActivityMineCollectBinding;
...
//        binding.fragmentMineQrcodeIv.setOnClickListener(this);
        ...
        binding.fragmentMineSmView.setOnClickListener(this);
        ...
        binding.fragmentMineIndexScLl.setOnClickListener(this);
...
//        binding.mineFragmentMyManagerItem7.viewMineFragmentItemCellIcon.setImageResource(R.mipmap.mine_fragment_index_cell_icon_kefu);
    ...
    private void updateUI(UserInfo userInfo) {
        ...
        binding.cavIcon.setCornerRadius(DensityUtils.dp2px(35));
    ...
    public void onClick(View v) {
        ...
        if (v == binding.fragmentMineIndexScLl) {
            CollectionListActivity.start(CollectionListActivity.class, context, null);
        } else if (v == binding.fragmentMineSmView) {
            ToastUtils.toastMsg("已实名");
        } else if (v == binding.fragmentMineSbglView) {
...
//            startActivity(new Intent(getContext(), SettingNotifyActivity.class));
            ...
            showLogin();
        } else if (v == binding.fragmentMineGotoUpgradeTv) {
...
////            XKitRouter.withKey(RouterConstant.PATH_FUN_COLLECTION_PAGE).withContext(this.requireContext()).navigate();
//        }
        if (v == binding.cavIcon || v == binding.fragmentMineEditIv || v == binding.layoutInfo) {
...
//        } else
        ...
        if (v == binding.fragmentMineIndexWdqbLl || v == binding.fragmentMineQbglView) {
