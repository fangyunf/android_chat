...
//    changeStatusBarColor(R.color.color_e9eff5);
    ...
    public void onMessageEvent(BaseEvent event) {
        if (event.getTag().equals("refreshUserInfo")) {
            ...
            viewBinding.tvName.setText(event.getText());
        }
    }
    ...
    private void initView() {
        ...
        viewBinding.flAvatar.setOnClickListener(this);
        viewBinding.flName.setOnClickListener(this);
...
//      viewBinding.activityMineAccountDetailUsername.viewTitleArrowRightTv.setVisibility(View.VISIBLE);
        ...
        viewBinding.tvName.setText(DataUtil.getUserInfo().username);
        viewBinding.tvId.setText("ID：" + DataUtil.getUserInfo().memberCode);
        viewBinding.tvPhone.setText(DataUtil.getUserInfo().phoneNo);
        GlideUtil.yh_loadImageRoundedCorner(this, viewBinding.cavAvatar, DataUtil.getUserInfo().avatar, 25);
    }

    @Override
    public void onClick(View v) {
        if (v == viewBinding.activityMineAccountDetailModifyNameTv || v == viewBinding.flName) {
            ModifyTextActivity.start(ModifyTextActivity.class, this, null);
        } else if (v == viewBinding.activityMineAccountDetailModifyHeadTv || v == viewBinding.flAvatar) {
    ...
    public void uploadImage(String imagePath, String descriptionText) {
        ...
        UploadUtil.uploadImage(imagePath, "", new CommonCallBack() {
            ...
            public void onCallBackUserBean(UserBean userBean) {
                ...
                GlideUtil.yh_loadImage(viewBinding.cavAvatar.getContext(), viewBinding.cavAvatar, userBean.url);
