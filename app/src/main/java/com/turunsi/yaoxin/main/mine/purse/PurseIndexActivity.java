...
public class PurseIndexActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding.layoutZd.setOnClickListener(view -> BillDetailListActivity.start(BillDetailListActivity.class, PurseIndexActivity.this, null));
        binding.layoutZfb.setOnClickListener(view -> BindAlipayActivity.start(BindAlipayActivity.class, PurseIndexActivity.this, null));
    }
