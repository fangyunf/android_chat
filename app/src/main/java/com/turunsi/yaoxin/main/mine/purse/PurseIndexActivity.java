...
public class PurseIndexActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void _initCell() {
        binding.activityMinePurseGridRecharge.setOnClickListener(this);
        binding.activityMinePurseIndexHbjl.setOnClickListener(this);
        binding.activityMinePurseIndexLqmx.setOnClickListener(this);
        binding.activityMinePurseGridPayPwd.setOnClickListener(this);
        binding.activityMinePurseIndexBdzfb.setOnClickListener(this);
        binding.activityMinePurseGridEditPwd.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        if (v == binding.activityMinePurseIndexNav.addCloseImageButton()) {
            finish();
        } else if (v == binding.activityMinePurseGridRecharge
                || v == binding.activityMinePurseIndexRechargeTv) {
        ...
        } else if (v == binding.activityMinePurseGridPayPwd) {
            Map map = new HashMap();
            map.put("type", "0");
            PursePwdManagerSetActivity.start(PursePwdManagerSetActivity.class, this, map);
        } else if (v == binding.activityMinePurseGridEditPwd) {
            Map map = new HashMap();
            map.put("type", "1");
            PursePwdManagerSetActivity.start(PursePwdManagerSetActivity.class, this, map);
