...
public class BankCardListAdapter extends BaseQuickAdapter<BankCardListBean, QuickViewHolder> {
    ...
    @Override
    protected int getItemCount(@NonNull List<? extends BankCardListBean> items) {
        return super.getItemCount(items) + 1;
    }

    @Override
    protected int getItemViewType(int position, @NonNull List<? extends BankCardListBean> list) {
