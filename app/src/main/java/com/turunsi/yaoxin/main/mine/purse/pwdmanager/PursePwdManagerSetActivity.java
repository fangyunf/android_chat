...
public class PursePwdManagerSetActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding.activityMinePursePwdManagerGetCode.viewTitleTfWithoutBgEt.setHint("请输入密保答案");
        binding.activityMinePursePwdManagerGetCode.viewTitleTfWithoutBgEt.setInputType(InputType.TYPE_CLASS_TEXT);
    ...
    private void _initModifyCell() {
        ...
        binding.activityMinePursePwdManagerSetPhone.viewTitleTfWithoutBgEt.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
    }
    ...
    public void onClick(View v) {
        if (v == binding.activityMinePursePwdManagerSetNav.addCloseImageButton()) {
            ...
            String field1 = getTextStr(binding.activityMinePursePwdManagerSetPhone.viewTitleTfWithoutBgEt).trim();
            String ans = getTextStr(binding.activityMinePursePwdManagerGetCode.viewTitleTfWithoutBgEt).trim();
            String pwd1 = getTextStr(binding.activityMinePursePwdManagerSetSetPwd.viewTitleTfWithoutBgEt).trim();
            String pwd2 = getTextStr(binding.activityMinePursePwdManagerSetConfirmPwd.viewTitleTfWithoutBgEt).trim();
            ...
            if (type == 1) {
                ...
                registerBean.payPassword = field1;
                registerBean.password = pwd1;
                registerBean.ans = ans;
                submitUpdateFullPassword(this, registerBean);
                return;
            }
    ...
    private static void submitUpdateFullPassword(Activity that, RegisterBean registerBean) {
