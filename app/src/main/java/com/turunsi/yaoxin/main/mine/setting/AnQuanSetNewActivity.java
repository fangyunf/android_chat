...
public class AnQuanSetNewActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        StatusBarUtils.transtStatusBar(this, viewBinding.activityMineSetAnquanSetNav);
        initView();
        _requestData();
    }
                ...
                .enqueue(
                        new CommonCallback<NetData>() {
                            ...
                            public void Successful(
                                ...
                                viewBinding.activityMineSetAnquanSetSwitchIv.setSelected(
                                        "1".equals(bean.state));
                            }
    ...
    public void onClick(View v) {
        if (v == viewBinding.activityMineSetAnquanSetNav.addCloseImageButton()) {
            ...
            Activity that = this;
            HttpUtil.apiW()
                    .home_flushToken(new RegisterBean())
                    .enqueue(
                            new CommonCallback<NetData>() {
                                @Override
                                public void Successful(
            ...
            HttpUtil.apiW()
                    .home_updateSd(new RegisterBean())
                    .enqueue(
                            new CommonCallback<NetData>() {
                                @Override
                                public void Successful(
                                    ...
                                    viewBinding.activityMineSetAnquanSetSwitchIv.setSelected(
                                            !viewBinding
                                                    .activityMineSetAnquanSetSwitchIv
                                                    .isSelected());
                                }
