...
public class NetManager {
    ...
    private static class NetManagerHolder {
        ...
        private static Retrofit INSTANCE1 = new Retrofit.Builder()
                ...
                .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
                .build();
        private static Retrofit INSTANCE2 = new Retrofit.Builder()
                .client(okHttpClient)
                .baseUrl(Constant.BASE_URL_8446)
                .addConverterFactory(GsonConverterFactory.create(
                        new GsonBuilder()
                                .setObjectToNumberStrategy(ToNumberPolicy.LONG_OR_DOUBLE)
                                .setNumberToNumberStrategy(ToNumberPolicy.LONG_OR_DOUBLE)
                ...
                .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
                .build();
        private static Retrofit INSTANCE3 = new Retrofit.Builder()
                .client(okHttpClient)
                .baseUrl(Constant.BASE_URL_8447)
                .addConverterFactory(GsonConverterFactory.create(
                        new GsonBuilder()
                                .setObjectToNumberStrategy(ToNumberPolicy.LONG_OR_DOUBLE)
                                .setNumberToNumberStrategy(ToNumberPolicy.LONG_OR_DOUBLE)
    ...
    public static Retrofit getInstance2() {
        return NetManagerHolder.INSTANCE2;
    }
    public static Retrofit getInstance3() {
        return NetManagerHolder.INSTANCE3;
    }
