...
public class IconTitleTemplate extends LinearLayout {
    public IconTitleTemplate(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            int bgColor = a.getColor(R.styleable.IconTitleArrowTemplate_bgColor, Color.WHITE);
