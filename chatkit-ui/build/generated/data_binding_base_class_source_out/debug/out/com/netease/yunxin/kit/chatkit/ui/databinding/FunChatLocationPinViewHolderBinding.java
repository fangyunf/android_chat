...
public final class FunChatLocationPinViewHolderBinding implements ViewBinding {
  @NonNull
  ...
  private FunChatLocationPinViewHolderBinding(@NonNull FrameLayout rootView,
  ...
  @NonNull
  public static FunChatLocationPinViewHolderBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FunChatLocationPinViewHolderBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fun_chat_location_pin_view_holder, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FunChatLocationPinViewHolderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FunChatLocationPinViewHolderBinding((FrameLayout) rootView, locationClick,
