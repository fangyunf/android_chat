...
public final class FunChatMessageLocationViewHolderBinding implements ViewBinding {
  @NonNull
  ...
  private FunChatMessageLocationViewHolderBinding(@NonNull RoundFrameLayout rootView,
  ...
  @NonNull
  public static FunChatMessageLocationViewHolderBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FunChatMessageLocationViewHolderBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fun_chat_message_location_view_holder, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FunChatMessageLocationViewHolderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FunChatMessageLocationViewHolderBinding((RoundFrameLayout) rootView, locationClick,
