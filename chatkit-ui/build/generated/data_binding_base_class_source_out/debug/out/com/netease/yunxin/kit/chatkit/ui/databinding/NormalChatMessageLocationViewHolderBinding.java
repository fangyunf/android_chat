...
public final class NormalChatMessageLocationViewHolderBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RoundFrameLayout locationItemRoot;

  @NonNull
  public final TextView locationItemTitle;

  private NormalChatMessageLocationViewHolderBinding(@NonNull RoundFrameLayout rootView,
      @NonNull View locationClick, @NonNull TextView locationItemAddress,
      @NonNull FrameLayout locationItemMapView, @NonNull RoundFrameLayout locationItemRoot,
      @NonNull TextView locationItemTitle) {
    ...
    this.locationItemRoot = locationItemRoot;
  ...
  @NonNull
  public static NormalChatMessageLocationViewHolderBinding inflate(
      @NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static NormalChatMessageLocationViewHolderBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup parent, boolean attachToParent) {
    View root = inflater.inflate(R.layout.normal_chat_message_location_view_holder, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NormalChatMessageLocationViewHolderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RoundFrameLayout locationItemRoot = (RoundFrameLayout) rootView;
      ...
      return new NormalChatMessageLocationViewHolderBinding((RoundFrameLayout) rootView,
          locationClick, locationItemAddress, locationItemMapView, locationItemRoot,
          locationItemTitle);
    }
