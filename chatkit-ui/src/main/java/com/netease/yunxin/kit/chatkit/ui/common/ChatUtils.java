...
public class ChatUtils {
     ...
     * 群聊导航栏标题：群名称 + 人数
     */
    public static String getTeamChatTitle(Context context, Team team) {
        ...
        return context.getString(R.string.chat_team_title_with_member_count, name, team.getMemberCount());
    }
