...
public class FunAudioRecordDialog extends Dialog {
    ...
    public void playRecordAnimator() {
        ...
        if (countDownTimer == null) {
            ...
            countDownTimer = new CountDownTimer(timeDuration * 1000L, 200) {
                @Override
                public void onTick(long millisUntilFinished) {
                    ...
                    if (showTime < remainingSeconds) {
                        ...
                        params.width = (int) (startLength + subLength * (timeDuration - (millisUntilFinished / 1000.f)) / timeDuration);
    ...
    private void switchView() {
        ...
        if (status == STATUS_RECORD) {
            ...
            viewBinding.bottomLayout.setBackgroundResource(R.drawable.fun_bg_chat_input_audio_bottom_recording);
            ...
            viewBinding.cancelView.setImageResource(R.drawable.fun_ic_chat_input_audio_record_cancel_selected);
            viewBinding.cancelTipsView.setVisibility(View.VISIBLE);
            viewBinding.sendTipsView.setVisibility(View.GONE);
            viewBinding.bottomLayout.setBackgroundResource(R.drawable.fun_bg_chat_input_audio_record_bottom_cancel);
        }
    }
