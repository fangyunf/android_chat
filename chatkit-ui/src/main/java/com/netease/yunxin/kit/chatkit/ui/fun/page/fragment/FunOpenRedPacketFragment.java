...
public class FunOpenRedPacketFragment extends BaseDialogFragment implements View.OnClickListener {
    ...
    public static void showV(FragmentManager fragmentManager, String redPacketId,int type,String groupId) {
...
//        fragment.sendTipMsg();
    ...
    public void onClick(View v) {
        ...
        if (v == binding.fragmentOpenRedPacketDialogDetailRl) {
            ...
            map.put("redpacketId",redBean.redPacketId);
            ...
            RegisterBean bean = new RegisterBean();
            bean.redpacketId = redBean.redPacketId;
    ...
    void sendTipMsg(boolean isGroup) {
        ...
        msgBean.sendUserId = redBean.sendId;
        msgBean.sendUserName = redBean.sendName;
