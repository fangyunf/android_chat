...
public class ChatZhuanZhangMessageViewHolder extends FunChatBaseMessageViewHolder {
  ...
  public void bindData(ChatMessageBean message, ChatMessageBean lastMessage) {
    ...
    if (!TextUtils.isEmpty(subtitle)) {
      viewBinding.funChatMessageRedPacketViewHolderGreetingTv.setVisibility(
    ...
    viewBinding.funChatMessageRedPacketViewHolderMoneyTv.setVisibility(android.view.View.VISIBLE);
