...
import static com.netease.yunxin.kit.chatkit.ui.ChatMessageType.RedPacket_ATTACHMENT;
import static com.netease.yunxin.kit.chatkit.ui.ChatMessageType.TIP_MESSAGE_VIEW_TYPE;
import static com.netease.yunxin.kit.chatkit.ui.ChatMessageType.ZhuanZhang_ATTACHMENT;
...
import com.netease.yunxin.kit.chatkit.ui.normal.view.message.viewholder.ChatRedPacketMessageViewHolder;
...
public abstract class ChatMessageViewHolderFactory implements IChatFactory {
    ...
    protected CommonBaseMessageViewHolder getViewHolderDefault(
        ...
        } else if (viewType == RedPacket_ATTACHMENT) {
            viewHolder = new ChatRedPacketMessageViewHolder(viewHolderBinding, viewType);
        } else if (viewType == ZhuanZhang_ATTACHMENT) {
