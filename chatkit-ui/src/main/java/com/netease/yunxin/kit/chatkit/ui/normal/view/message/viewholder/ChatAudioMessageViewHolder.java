...
import com.netease.yunxin.kit.chatkit.ui.databinding.NormalChatMessageAudioViewHolderBinding;
...
public class ChatAudioMessageViewHolder extends NormalChatBaseMessageViewHolder {

  private NormalChatMessageAudioViewHolderBinding audioBinding;
  ...
  /**
   * 重写基类的长按处理，为音频消息添加模式切换功能
   */
  @Override
  protected void setStatusCallback() {
    super.setStatusCallback();
    
    // 为音频消息容器添加长按监听器
    audioBinding.container.setOnLongClickListener(v -> {
      if (isMultiSelect) {
