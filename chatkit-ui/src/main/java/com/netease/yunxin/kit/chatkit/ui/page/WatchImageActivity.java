...
public class WatchImageActivity extends WatchBaseActivity {
    ...
    public void initData(Intent intent) {
        if (intent != null) {
            ...
            ALog.d(LIB_TAG, TAG, "initData message size: " + messages.size() + " firstIndex:" + firstDisplayImageIndex);
        } else {
            finish();
        }
    }
    ...
    public void initDataObserver() {
        ...
        viewModel.getStatusMessageLiveData().observe(this, messageStatusChangeResult -> {
            ...
            ALog.d(LIB_TAG, TAG, "message livedata observe -->> pos:" + pos + " " + messageStatusChangeResult.getLoadStatus());
            if (pos >= 0) {
    ...
    public void saveMedia() {
        ...
        if (position >= 0 && position < messages.size()) {
            ...
            Permission.requirePermissions(this, permission).request(new Permission.PermissionCallback() {
                @Override
                public void onGranted(List<String> permissionsGranted) {
                    if (permissionsGranted.contains(Manifest.permission.WRITE_EXTERNAL_STORAGE) || permissionsGranted.contains(Manifest.permission.READ_MEDIA_IMAGES)) {
                        ...
                        Toast.makeText(WatchImageActivity.this, WatchImageActivity.this.getResources().getString(R.string.permission_default), Toast.LENGTH_SHORT).show();
                    }
                }
