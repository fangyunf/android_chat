...
public class FunSelectedListAdapter
  ...
  protected void handleBindViewHolder(
    ...
    holder.binding.funFriendSelectedViewHolderAvatarView.setData(
        friendData.getAvatar(),
        friendData.getName(),
        AvatarColor.avatarColor(friendData.getAccount()));

      holder.binding.funFriendSelectedViewHolderAvatarView.setCornerRadius(DensityUtils.dp2px(20));
