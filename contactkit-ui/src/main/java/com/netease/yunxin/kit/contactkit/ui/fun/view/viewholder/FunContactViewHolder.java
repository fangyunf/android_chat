...
public class FunContactViewHolder extends BaseContactViewHolder {
  ...
  private final int cornerSize = SizeUtils.dp2px(20);
  ...
  public void onBind(BaseContactBean bean, int position, ContactListViewAttrs attrs) {
    ...
    binding.funFriendContactViewHolderAvatarView.setCornerRadius(cornerSize);
    binding.funFriendContactViewHolderAvatarView.setData(
  ...
  private void loadConfig(ContactListViewAttrs attrs) {
    ...
    if (attrs.getAvatarCornerRadius() != ContactListViewAttrs.INT_NULL) {
      binding.funFriendContactViewHolderAvatarView.setCornerRadius(attrs.getAvatarCornerRadius());
    }
  }
}
