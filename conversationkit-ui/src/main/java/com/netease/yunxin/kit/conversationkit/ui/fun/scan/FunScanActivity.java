//package com.netease.yunxin.kit.conversationkit.ui.fun.scan;
//
...
// */
//
//public class FunScanActivity extends BaseActivity implements QRCodeView.Delegate , EasyPermissions.PermissionCallbacks{
//
...
//        findViewById(R.id.iv_toolbar_back).setOnClickListener(v -> finish());
//        mTvTitle.setText("扫描");
...
//            Map map = new HashMap();
//            map.put("code",result);
//            start(AssetsDetailActivity.class,this,map);
//        } else {
//            finish();
//        }
//    }
