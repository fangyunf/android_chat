...
public class FunConversationBaseViewHolder extends BaseViewHolder<ConversationBean> {
    ...
    public void onBindData(ConversationBean data, int position) {
        ...
        if (data.infoData.isStickTop()) {
            ...
            viewBinding.rootLayout.setBackgroundResource(com.yaoxin.appbase.R.mipmap.ic_message_top_bg);
        } else {
            viewBinding.rootLayout.setBackgroundResource(com.yaoxin.appbase.R.mipmap.ic_message_base_bg);
        ...
        viewBinding.messageTv.setText(ConversationUtils.getConversationText(itemView.getContext(), data.infoData));
        viewBinding.timeTv.setText(TimeFormatUtils.formatMillisecond(viewBinding.getRoot().getContext(), data.infoData.getTime()));
        ...
        viewBinding.avatarLayout.setOnLongClickListener(v -> itemListener.onAvatarLongClick(v, data, position));
    }

    private void loadUIConfig() {
        itemDrawable = viewBinding.getRoot().getContext().getDrawable(R.drawable.fun_conversation_view_holder_selector);
        stickTopDrawable = viewBinding.getRoot().getContext().getDrawable(R.drawable.fun_conversation_view_holder_stick_selector);
