...
public abstract class BaseTeamSettingActivity extends BaseActivity {
  ...
  protected TextView forbiddenManager;
  ...
  protected void checkViews() {
    ...
    Objects.requireNonNull(forbiddenManager);
  ...
  protected Class<? extends Activity> getTeamMemberForbiddenListActivity() {
    return null;
  }
  ...
  protected void toForbiddenManagerPage() {}
  ...
  private void initForOwner() {
    ...
    forbiddenManager.setVisibility(View.VISIBLE);
    forbiddenManager.setOnClickListener(v -> toForbiddenManagerPage());
  ...
  private void initForAllUser() {
    ...
    forbiddenManager.setVisibility(View.GONE);
    tvQuit.setText(R.string.team_advanced_quit);
    tvQuit.setOnClickListener(
        v -> {
          CommonChoiceDialog dialog = new CommonChoiceDialog();
