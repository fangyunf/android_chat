...
public class FunTeamSettingActivity extends BaseTeamSettingActivity {
  ...
  protected View initViewAndGetRootView(Bundle savedInstanceState) {
    ...
    forbiddenManager = binding.funTeamSettingActivityForbiddenGetCoupon;
  ...
  protected Class<? extends Activity> getTeamMemberForbiddenListActivity() {
    return FunTeamForbiddenMemberListActivity.class;
  }
  ...
  protected void toForbiddenManagerPage() {
    ...
    FunTeamForbiddenMemberListActivity.launch(
            this, getTeamMemberForbiddenListActivity(), teamInfo);
  }
}
