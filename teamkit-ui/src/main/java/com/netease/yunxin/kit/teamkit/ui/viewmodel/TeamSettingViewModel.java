      ...
      HttpUtil.api8446().group_quitGroup(ben)
              .enqueue(new CommonCallback<NetData>() {
                  ...
                  public void Successful(Call<NetData> call, Response<NetData> response, NetData body) {
                      ...
                      quitTeamData.setValue(new ResultInfo<>());
                  }
...
//                          return;
//                      }
                      quitTeamData.setValue(new ResultInfo<>(null, false, new ErrorMsg(-1)));
...
//        });
  ...
  HttpUtil.api8446().group_dissolveGroup(ben)
          .enqueue(new CommonCallback<NetData>() {
              @Override
              public void Successful(Call<NetData> call, Response<NetData> response, NetData body) {
                  dismissTeamData.setValue(new ResultInfo<>());
              }

              @Override
              public void Failure(Call<NetData> call, Throwable t) {
                  dismissTeamData.setValue(new ResultInfo<>(null, false, new ErrorMsg(-1)));
              }
          });
